...
- Recompiled plugin with [tailpipe-plugin-sdk v0.9.2](https://github.com/turbot/tailpipe-plugin-sdk/blob/develop/CHANGELOG.md#v092-2025-07-24) that fixes incorrect data ranges for zero‑granularity collections and prevents crashes in certain collection states. ([#228](https://github.com/turbot/tailpipe-plugin-aws/pull/228))

## v0.14.1 [2025-07-02]

_Dependencies_

- Recompiled plugin with [tailpipe-plugin-sdk v0.9.1](https://github.com/turbot/tailpipe-plugin-sdk/blob/develop/CHANGELOG.md#v091-2025-07-02) that fixes collection state issues. ([#217](https://github.com/turbot/tailpipe-plugin-aws/pull/217))

## v0.14.0 [2025-07-02]

_Dependencies_

- Recompiled plugin with [tailpipe-plugin-sdk v0.9.0](https://github.com/turbot/tailpipe-plugin-sdk/blob/develop/CHANGELOG.md#v090-2025-07-02) to support the `--to` flag, directional time-based collection, and improved tracking of collected data. ([#216](https://github.com/turbot/tailpipe-plugin-aws/pull/216))
