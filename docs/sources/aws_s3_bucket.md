...
| connection  | Connection           | No       | `connection.aws.default` | The [AWS connection](https://hub.tailpipe.io.plugins/turbot/aws#connection-credentials) to use to connect to the AWS account. |
