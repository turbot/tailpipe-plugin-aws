...
func (c *CostAndUsageLog) GetColumnDescriptions() map[string]string {
	return map[string]string{
		...
		"product_servicecode":                                      "This identifies the specific AWS service to the customer as a unique short abbreviation.",
		"product_servicename":                                      "A simplified description about the AWS service.",
