...
type CostAndUsageLog struct {
	...
	LineItemNormalizationFactor                           *string    `json:"line_item_normalization_factor,omitempty" parquet:"name=line_item_normalization_factor"`
	LineItemNormalizedUsageAmount                         *string    `json:"line_item_normalized_usage_amount,omitempty" parquet:"name=line_item_normalized_usage_amount"`
	...
	LineItemUnblendedCost                                 *string    `json:"line_item_unblended_cost,omitempty" parquet:"name=line_item_unblended_cost"`
	LineItemBlendedRate                                   *string    `json:"line_item_blended_rate,omitempty" parquet:"name=line_item_blended_rate"`
	LineItemBlendedCost                                   *string    `json:"line_item_blended_cost,omitempty" parquet:"name=line_item_blended_cost"`
	...
	ProductCputupe                                        *string    `json:"product_cputupe,omitempty" parquet:"name=product_cputupe"`
	...
	ProductData                                           *string    `json:"product_data,omitempty" parquet:"name=product_data"`
	...
	PricingPublicOnDemandCost                             *string    `json:"pricing_public_on_demand_cost,omitempty" parquet:"name=pricing_public_on_demand_cost"`
	...
	ReservationAmortizedUpfrontCostForUsage               *string    `json:"reservation_amortized_upfront_cost_for_usage,omitempty" parquet:"name=reservation_amortized_upfront_cost_for_usage"`
	ReservationAmortizedUpfrontFeeForBillingPeriod        *string    `json:"reservation_amortized_upfront_fee_for_billing_period,omitempty" parquet:"name=reservation_amortized_upfront_fee_for_billing_period"`
	ReservationEffectiveCost                              *string    `json:"reservation_effective_cost,omitempty" parquet:"name=reservation_effective_cost"`
	...
	ReservationRecurringFeeForUsage                       *string    `json:"reservation_recurring_fee_for_usage,omitempty" parquet:"name=reservation_recurring_fee_for_usage"`
	ReservationStartTime                                  *string    `json:"reservation_start_time,omitempty" parquet:"name=reservation_start_time"`
	...
	ReservationUnusedAmortizedUpfrontFeeForBillingPeriod  *string    `json:"reservation_unused_amortized_upfront_fee_for_billing_period,omitempty" parquet:"name=reservation_unused_amortized_upfront_fee_for_billing_period"`
	ReservationUnusedNormalizedUnitQuantity               *string    `json:"reservation_unused_normalized_unit_quantity,omitempty" parquet:"name=reservation_unused_normalized_unit_quantity"`
	ReservationUnusedQuantity                             *string    `json:"reservation_unused_quantity,omitempty" parquet:"name=reservation_unused_quantity"`
	ReservationUnusedRecurringFee                         *string    `json:"reservation_unused_recurring_fee,omitempty" parquet:"name=reservation_unused_recurring_fee"`
	ReservationUpfrontValue                               *string    `json:"reservation_upfront_value,omitempty" parquet:"name=reservation_upfront_value"`
	...
	SavingsPlanSavingsPlanEffectiveCost                   *string    `json:"savings_plan_savings_plan_effective_cost,omitempty" parquet:"name=savings_plan_savings_plan_effective_cost"`
	SavingsPlanAmortizedUpfrontCommitmentForBillingPeriod *string    `json:"savings_plan_amortized_upfront_commitment_for_billing_period,omitempty" parquet:"name=savings_plan_amortized_upfront_commitment_for_billing_period"`
	SavingsPlanRecurringCommitmentForBillingPeriod        *string    `json:"savings_plan_recurring_commitment_for_billing_period,omitempty" parquet:"name=savings_plan_recurring_commitment_for_billing_period"`
