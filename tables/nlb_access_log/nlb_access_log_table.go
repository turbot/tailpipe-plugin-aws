...
func (c *NlbAccessLogTable) GetDescription() string {
	return "AWS NLB Access logs capture detailed information about the connections that pass through a Network Load Balancer. This table provides a structured representation of the log data, including TLS handshake details, client and destination information, connection duration, and security parameters."
}
